...
public class BaseSupplierPA {
	...
	public final String INSERT_SQL = "INSERT INTO supplier_pa(Master_code,Branch_code,Branch_name,Consumer_name,Incharge_mobile,Address,T_date,In_stock,Brand,Product_id,Product_code,Product_name,Variant,Receipts,Issues,Units,Total_price,Token_id,Status) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?)"; 
